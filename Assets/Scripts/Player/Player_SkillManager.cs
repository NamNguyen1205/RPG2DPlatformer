...
public class Player_SkillManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        allsSkills = GetComponentsInChildren<Skill_Base>();
    }

    public void ReduceAllSkillCooldownBy(float amount)
    {
        foreach (var skill in allsSkills)
    ...
    public Skill_Base GetSkillByType(SkillType type)
    {
        switch (type)
        {
            ...
            default:
                Debug.Log($"Skill type {type} is not implementd yet.");
                return null;
        }
    }
}
