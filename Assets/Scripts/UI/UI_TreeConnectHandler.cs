...
public class UI_TreeConnectHandler : MonoBehaviour
{
    ...
    public void UpdateConnections()
    {
        for (int i = 0; i < connectionDetails.Length; i++)
        {
            ...
            // connected child node position = detail.GetConnectionPoint
            ...
            detail.childNode.SetPostion(targetPosition);
    ...
    public void SetPostion(Vector2 position) => rect.anchoredPosition = position;
